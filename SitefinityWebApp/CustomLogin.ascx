...
<fieldset id="sfLoginWidgetWrp">
    <asp:Panel ID="loginWidgetPanel" runat="server">
	    ...
	    <div class="sfSubmitBtnWrp">
		    <asp:LinkButton ID="LoginButton" CssClass="sfSubmitBtn button" ValidationGroup="LoginBox" OnClientClick="return false;" runat="server">
    ...
    <asp:Panel ID="lostPasswordPanel" runat="server" Visible="false" CssClass="sfLoginFieldsWrp sfLostPasswordWrp">
        ...
        <div class="sfSubmitBtnWrp">
            <asp:Button ID="sendRecoveryMailBtn" runat="server" Text="<%$ Resources:Labels, Submit %>" ValidationGroup="loginWidget" CssClass="sfSubmitBtn button" />
        </div>
    </asp:Panel>
